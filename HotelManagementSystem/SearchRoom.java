	...
	public void actionPerformed(ActionEvent ae) {
		...
		if (ae.getSource() == b1) {
			try (conn c = new conn()) {
				...
				String str = "select * from room where bed_type = ?";
				String str2 = "select * from room where bed_type = ? AND availability = 'Available'";
				...
				JOptionPane.showMessageDialog(null, "Error searching rooms. Please try again.");
			} catch (Exception e) {
